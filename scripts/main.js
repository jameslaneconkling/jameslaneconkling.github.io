...
},{"./models/app":2,"./views/appView":6,"jquery":19,"underscore":20}],2:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"columns\">\n  <ul class=\"no-bullet left v-align-center title\">\n    <li class=\"title animate\">\n      <h2>James Conkling</h2>\n    </li>\n  </ul>\n  <ul class=\"no-bullet right v-align-center menu\">\n    <li>\n      <a href=\"//www.linkedin.com/in/";
  if (helper = helpers.linkedin) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.linkedin); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "/\" target=\"_blank\" title=\"linkedIn\">\n        <i class=\"fa fa-linkedin\"></i><span class=\"hide-for-small-only\"></span>\n      </a>\n    </li>\n    <li>\n      <a href=\"//github.com/";
  if (helper = helpers.github) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.github); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "\" target=\"_blank\" title=\"github\">\n        <i class=\"fa fa-github-alt\"></i><span class=\"hide-for-small-only\"></span>\n      </a>\n    </li>\n    <li>\n      <a href=\"mailto:";
  if (helper = helpers.email) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.email); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "\" target=\"_blank\" title=\"email\">\n        <i class=\"fa fa-envelope-o\"></i><span class=\"hide-for-small-only\"></span>\n      </a>\n    </li>\n    <li>\n      <a href=\"assets/resume.pdf\" target=\"_blank\" title=\"resume\">\n        <i class=\"fa fa-file-text-o\"></i><span class=\"hide-for-small-only\">resume</span>\n      </a>\n    </li>\n  </ul>\n</div>\n";
  return buffer;
  });

},{"hbsfy/runtime":18}],4:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n      <li class=\"item animate clearfix ";
  ...
  buffer += "\">\n        <div class=\"header\">\n          <div class=\"thumb\" style=\"background-image: url('images/thumb/"
...
function program4(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n        <article class=\"animate\">\n          <ul class=\"details inline-list\">\n            ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.url), {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.github), {hash:{},inverse:self.noop,fn:self.program(7, program7, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n          </ul>\n          <p>";
...
function program7(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "<li><a href=\"http://"
    + escapeExpression(((stack1 = (depth0 && depth0.github)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
  ...
  buffer += escapeExpression(stack1)
    + "-plate\" class=\"plate animate\">\n  <h1 class=\"title show-for-small-only\">";
  if (helper = helpers.name) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.name); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<p class=\"bio\">I am a web developer, cartographer, and data analyst working on open source geographic data platforms in the environmental, human rights, and natural resource management worlds.  Find me wandering the blurry overlap between technology and global policy challenges.</p>\n<ul class=\"\">\n  <li class=\"title projects\">\n    <h1><a href=\"#\">projects</a></h1>\n  </li>\n<!--   <li class=\"title code\">\n    <h1><a href=\"#\">code</a></h1>\n  </li> -->\n  <li class=\"title cartography\">\n    <h1><a href=\"#\">cartography</a></h1>\n  </li>\n</ul>\n";
  });
...
module.exports = Backbone.View.extend({
  ...
  initialize: function (){
    ...
    // set active plate
    this.model.set('collection', 'projects');
  },
...
},{"./headerView":7,"./plateView":8,"./sideView":9,"backbone":10,"jquery":19,"underscore":20}],7:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../templates/header.hbs":3,"backbone":10}],8:[function(require,module,exports){
var Backbone = require('backbone');
var _ = require('underscore');
var $ = require('jquery');
...
},{"../templates/plate.hbs":4,"backbone":10,"jquery":19,"underscore":20}],9:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../templates/side.hbs":5,"backbone":10}],10:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
},{"jquery":19,"underscore":20}],11:[function(require,module,exports){
"use strict";
